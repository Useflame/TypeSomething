    ...
    <div class="row">
      <div class="col">
        <div class="type-field">
          ...
          <span class="current-word right">{{
            currentWord.substr(0, greenWord)
          }}</span>
          <span class="current-word wrong">{{
            currentWord.substr(greenWord, redWord)
          }}</span>
          <span class="current-word">{{
            currentWord.substr(greenWord + redWord)
          }}</span>
          <span class="wrong">{{
            " " + text.substr(0, redWord - currentWord.length)
          }}</span>
          <span v-if="currentWord.length > redWord">{{ " " + text }}</span>
